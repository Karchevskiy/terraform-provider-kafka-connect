...
// oauthClient support all function of kafka-connect API + some more features
...
func NewOauthClient(url string) OAuthClient {
	return &oauthClient{client: newCustomBaseClient(url), maxParallelRequest: 3}
}

//Set the limit of parallel call to kafka-connect server
//Default to 3
func (c *oauthClient) SetParallelism(value int) {
	c.maxParallelRequest = value
}

func (c *oauthClient) SetInsecureSSL() {
	c.client.SetInsecureSSL()
}

func (c *oauthClient) SetDebug() {
	c.client.SetDebug()
}

func (c *oauthClient) SetClientCertificates(certs ...tls.Certificate) {
...
func (c *oauthClient) GetAll() (GetAllConnectorsResponse, error) {
	return c.client.GetAll()
}

//GetConnector return information on specific connector
func (c *oauthClient) GetConnector(req ConnectorRequest) (ConnectorResponse, error) {
	return c.client.GetConnector(req)
}

//CreateConnector create connector using specified config and name
func (c *oauthClient) CreateConnector(req CreateConnectorRequest, sync bool) (ConnectorResponse, error) {
...
func (c *oauthClient) UpdateConnector(req CreateConnectorRequest, sync bool) (ConnectorResponse, error) {
...
func (c *oauthClient) DeleteConnector(req ConnectorRequest, sync bool) (EmptyResponse, error) {
...
func (c *oauthClient) GetConnectorConfig(req ConnectorRequest) (GetConnectorConfigResponse, error) {
	return c.client.GetConnectorConfig(req)
}

//GetConnectorStatus return current status of connector
func (c *oauthClient) GetConnectorStatus(req ConnectorRequest) (GetConnectorStatusResponse, error) {
	return c.client.GetConnectorStatus(req)
}

//RestartConnector restart connector
func (c *oauthClient) RestartConnector(req ConnectorRequest) (EmptyResponse, error) {
	return c.client.RestartConnector(req)
}

//PauseConnector pause a running connector
//asynchronous operation
func (c *oauthClient) PauseConnector(req ConnectorRequest, sync bool) (EmptyResponse, error) {
...
//asynchronous operation
func (c *oauthClient) ResumeConnector(req ConnectorRequest, sync bool) (EmptyResponse, error) {
...
func (c *oauthClient) IsUpToDate(connector string, config map[string]interface{}) (bool, error) {
...
func (c *oauthClient) DeployConnector(req CreateConnectorRequest) (err error) {
...
func (c *oauthClient) DeployMultipleConnector(connectors []CreateConnectorRequest) (err error) {
...
func (c *oauthClient) GetAllTasks(req ConnectorRequest) (GetAllTasksResponse, error) {
	return c.client.GetAllTasks(req)
}

//GetTaskStatus return current status of task
func (c *oauthClient) GetTaskStatus(req TaskRequest) (TaskStatusResponse, error) {
	return c.client.GetTaskStatus(req)
}

//RestartTask try to restart task
func (c *oauthClient) RestartTask(req TaskRequest) (EmptyResponse, error) {
